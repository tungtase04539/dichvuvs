      ...
      <section className="bg-gradient-hero pt-32 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              {product.featured && (
                <span className="inline-flex items-center gap-1 px-3 py-1 bg-amber-400 text-slate-900 text-xs font-bold rounded-full mb-2">
      ...
      <main className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100">
                <h2 className="text-xl font-bold text-slate-900 mb-4">Mô tả sản phẩm</h2>
              ...
              {/* Long Description */}
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100">
                <h2 className="text-xl font-bold text-slate-900 mb-6">Chi tiết sản phẩm</h2>
                <div className="prose prose-slate max-w-none">
                  {product.longDescription ? (
                    <div className="whitespace-pre-wrap text-slate-600">{product.longDescription}</div>
                  ) : (
                    <div className="space-y-6 text-slate-600">
                      <p>
                        <strong className="text-slate-900">{product.name}</strong> là giải pháp ChatBot AI tiên tiến, 
                        được thiết kế đặc biệt để tự động hóa quy trình kinh doanh và tăng hiệu quả tương tác với khách hàng.
                      </p>

                      <div>
                        <h3 className="text-lg font-bold text-slate-900 mb-3">🚀 Lợi ích khi sử dụng:</h3>
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-slate-900 mb-3">📦 Bạn sẽ nhận được:</h3>
                        <ul className="space-y-2">
                          {[
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                ...
                <div className="mb-6">
                  ...
                  <span className="inline-flex px-3 py-1 bg-red-100 text-red-600 text-sm font-bold rounded-full">
                    Giảm 50%
                  </span>
                </div>
              ...
              {/* Specs */}
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                <h3 className="font-bold text-slate-900 mb-4">Thông số sản phẩm</h3>
          ...
          {relatedProducts.length > 0 && (
            <div className="mt-16">
              <h2 className="text-2xl font-bold text-slate-900 mb-8">ChatBot liên quan</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {relatedProducts.map((item) => (
                  <Link
                    key={item.id}
                    href={`/san-pham/${item.slug}`}
                    className="group bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-lg hover:border-primary-200 transition-all hover:-translate-y-1"
                  >
