...
export async function isStaff(): Promise<boolean> {
  ...
  return ["admin", "staff", "distributor", "agent", "senior_collaborator", "collaborator"].includes(session.role);
}
...
export async function isPartner(): Promise<boolean> {
  ...
  return ["distributor", "agent", "senior_collaborator", "collaborator"].includes(session.role);
}
